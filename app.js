...
function verificarIntento() {
    let numeroDeUsuario = document.getElementById('valorUsuario').value; //getelementbyid para seleccionar un ID de html y el .value es para tomar el valor ingresado
